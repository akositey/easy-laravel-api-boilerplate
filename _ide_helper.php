 ...
 * Generated for Laravel 7.3.0 on 2020-03-31 02:44:43.
 *
...
namespace App\References {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|SupportingDocument[]|SupportingDocument create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|SupportingDocument[]|SupportingDocument make($attributes = [])
    */
    class SupportingDocumentFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\References {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|ResponsibilityCenterType[]|ResponsibilityCenterType create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|ResponsibilityCenterType[]|ResponsibilityCenterType make($attributes = [])
    */
    class ResponsibilityCenterTypeFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\References {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|ResponsibilityCenter[]|ResponsibilityCenter create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|ResponsibilityCenter[]|ResponsibilityCenter make($attributes = [])
    */
    class ResponsibilityCenterFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
...
namespace App\References {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Debtor[]|Debtor create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Debtor[]|Debtor make($attributes = [])
    */
    class DebtorFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\References {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Employee[]|Employee create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Employee[]|Employee make($attributes = [])
    */
    class EmployeeFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
